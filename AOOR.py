...
global parametersList_AOOR
parametersList_AOOR = [0]*21

class AOOR():
    
    def __init__(self, name, LRL, URL, AA, APW, MSR, AT, ReaT, ResF, RecT): #parameters
        ...
        self.ResF = ResF
        self.RecT = RecT
        parametersList_AOOR[0] = 1
        parametersList_AOOR[2] = LRL
        parametersList_AOOR[3] = URL
        parametersList_AOOR[4] = AA*10
        parametersList_AOOR[6] = APW*100
        parametersList_AOOR[13] = MSR
        parametersList_AOOR[14] = AT
        parametersList_AOOR[15] = ReaT
        parametersList_AOOR[16] = ResF
        parametersList_AOOR[17] = RecT
        parametersList_AOOR[18] = 1
        parametersList_AOOR[19] = 16
        parametersList_AOOR[20] = 55
    ...
    def set_from_csv(self):#Obtains values from 1nd row in the users CSV file
        ...
        self.LRL = df.loc[6, "P1"]   
        self.URL = df.loc[6, "P2"]
        self.AA = df.loc[6, "P3"]
        self.APW = df.loc[6, "P4"]
        self.MSR = df.loc[6, "P5"] #might have to swap positions 
        self.AT = df.loc[6, "P6"]
        self.ReaT = df.loc[6, "P7"]
        self.ResF = df.loc[6, "P8"]
        self.RecT = df.loc[6, "P9"]
        parametersList_AOOR[0] = 1
        parametersList_AOOR[2] = self.LRL
        parametersList_AOOR[3] = self.URL
        parametersList_AOOR[4] = self.AA*10
        parametersList_AOOR[6] = self.APW*100
        parametersList_AOOR[13] = self.MSR
        parametersList_AOOR[14] = self.AT
        parametersList_AOOR[15] = self.ReaT
        parametersList_AOOR[16] = self.ResF
        parametersList_AOOR[17] = self.RecT
        parametersList_AOOR[18] = 1
        parametersList_AOOR[19] = 16
        parametersList_AOOR[20] = 55
    ...
    def change(self):
        layout = [
            [sg.Text("Changing values of AOOR")],
            [sg.Text("",key="status")],
            ...
            [sg.Text('APW: ' + str(self.APW) + "V",key="t4"), sg.Button('+', key="B4+"), sg.Button('-', key="B4-")],
